...
import com.example.healthproject.data.repository.*
import com.example.healthproject.databinding.FragmentMesDemandesBinding
import com.example.healthproject.viewmodel.*
...
class MesDemandesFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // ✅ NAVIGATION
        adapter.onDetailClickListener = { missionId, isSuperviseur ->
            val action =
                MesDemandesFragmentDirections
                    .actionMesDemandesFragmentToDescriptionMissionFragment(
                        missionId,
                        isSuperviseur
                    )
    ...
    private fun getSelectedStatus(): DemandeStatus? =
        when (binding.spinnerStatusFilter.selectedItem.toString()) {
